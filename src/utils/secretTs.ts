...
export function parseExistingSecretKeysFromTs(): string[] {
  if (!fs.existsSync(SECRET_TS_FILE)) return []
...
export function writeSecretTs(keys: string[]) {
...
export function removeSecretKeyFromTs(keys: string[], keyToRemove: string): string[] {
